...
int dsi_panel_pre_prepare(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_pre_prepare -- start");
	mutex_lock(&panel->panel_lock);
#if 0
...
error:
	mutex_unlock(&panel->panel_lock);
	pr_debug("[lcd_performance]dsi_panel_pre_prepare -- end");
	return rc;
}
...
int dsi_panel_prepare(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_prepare -- start");
	mutex_lock(&panel->panel_lock);
...
error:
	mutex_unlock(&panel->panel_lock);
	pr_debug("[lcd_performance]dsi_panel_prepare -- end");
	return rc;
}
...
int dsi_panel_enable(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_enable -- start");
	mutex_lock(&panel->panel_lock);
	...
	pr_debug("[lcd_performance]dsi_panel_enable -- end");
	return rc;
}
...
int dsi_panel_post_enable(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_post_enable -- start");
	mutex_lock(&panel->panel_lock);
...
error:
	mutex_unlock(&panel->panel_lock);
	pr_debug("[lcd_performance]dsi_panel_post_enable -- end");
	return rc;
}
...
int dsi_panel_pre_disable(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_pre_disable -- start");
	mutex_lock(&panel->panel_lock);
...
error:
	mutex_unlock(&panel->panel_lock);
	pr_debug("[lcd_performance]dsi_panel_pre_disable -- end");
	return rc;
}
...
int dsi_panel_disable(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_disable -- start");
	mutex_lock(&panel->panel_lock);
...
error:
	...
	pr_debug("[lcd_performance]dsi_panel_disable -- end");
...
int dsi_panel_unprepare(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_unprepare -- start");
	mutex_lock(&panel->panel_lock);
...
error:
	mutex_unlock(&panel->panel_lock);
	pr_debug("[lcd_performance]dsi_panel_unprepare -- end");
	return rc;
}
...
int dsi_panel_post_unprepare(struct dsi_panel *panel)
{
	...
	pr_debug("[lcd_performance]dsi_panel_post_unprepare -- start");
	mutex_lock(&panel->panel_lock);
...
error:
	mutex_unlock(&panel->panel_lock);
	pr_debug("[lcd_performance]dsi_panel_post_unprepare -- end");
	return rc;
}
